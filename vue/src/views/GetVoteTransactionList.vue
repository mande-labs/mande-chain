...
export default defineComponent ({
  name: 'GetVoteTransactionList',

  components: { SpSpinner, VoteTransactionListItem },
  ...
  async setup() {
    ...
    let { pager, normalize, newTxs, filterSupportedTypes } = await useVoteTxs({
      $s,
      opts: { order: 'desc', realTime: true }
    })

    // computed
    let list = computed<VoteTxForUI[]>(() => {
