...
export interface VotingVoteBook {
  index?: string;
  caster?: string;
  receiver?: string;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mande-chain/voting/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<VotingQueryParamsResponse, RpcStatus>({
      path: `/mande-chain/voting/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   *
   * @tags Query
   * @name QueryVoteBookAll
   * @summary Queries a list of VoteBook items.
   * @request GET:/mande-chain/voting/vote_book
   */
  queryVoteBookAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<VotingQueryAllVoteBookResponse, RpcStatus>({
      path: `/mande-chain/voting/vote_book`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryVoteBook
   * @summary Queries a VoteBook by index.
   * @request GET:/mande-chain/voting/vote_book/{index}
   */
  queryVoteBook = (index: string, params: RequestParams = {}) =>
    this.request<VotingQueryGetVoteBookResponse, RpcStatus>({
      path: `/mande-chain/voting/vote_book/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
