<template>
  ...
  <div v-else class="tx-list">
    <div class="title">Votes</div>
    <div class="empty">Voting history is empty</div>
  </div>
</template>
...
import GetVoteTransactionList from './GetVoteTransactionList.vue'

export default defineComponent ({
  name: 'VoteTransactionList',

  components: { GetVoteTransactionList },
