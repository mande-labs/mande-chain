...
export interface AggregateVotesReceived {
  index: string;
  positive: number;
  negative: number;
}

const baseAggregateVotesReceived: object = {
  index: "",
  positive: 0,
  negative: 0,
};

export const AggregateVotesReceived = {
  encode(
  ...
  decode(input: Reader | Uint8Array, length?: number): AggregateVotesReceived {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseAggregateVotesReceived } as AggregateVotesReceived;
  ...
  fromJSON(object: any): AggregateVotesReceived {
    const message = { ...baseAggregateVotesReceived } as AggregateVotesReceived;
  ...
  toJSON(message: AggregateVotesReceived): unknown {
    const obj: any = {};
  ...
  fromPartial(
    object: DeepPartial<AggregateVotesReceived>
