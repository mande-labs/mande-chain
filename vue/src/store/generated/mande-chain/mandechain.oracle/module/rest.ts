 ...
 */
export type OracleParams = object;

export interface OracleQueryLastNetworkConstantIdResponse {
  /** @format int64 */
  request_id?: string;
}

export interface OracleQueryNetworkConstantResponse {
  result?: OracleNetworkConstantResult;
}
