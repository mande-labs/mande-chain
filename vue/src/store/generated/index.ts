...
import MandeChainMandechainOracle from './mande-chain/mandechain.oracle'
import MandeChainMandechainSsi from './mande-chain/mandechain.ssi'
import MandeChainMandechainVoting from './mande-chain/mandechain.voting'
...
export default { 
  ...
  MandeChainMandechainOracle: load(MandeChainMandechainOracle, 'mandechain.oracle'),
  MandeChainMandechainSsi: load(MandeChainMandechainSsi, 'mandechain.ssi'),
  MandeChainMandechainVoting: load(MandeChainMandechainVoting, 'mandechain.voting'),
