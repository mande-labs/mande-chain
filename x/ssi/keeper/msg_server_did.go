...
// RPC controller for registering DID document
...
// RPC controller for updating an existing DID document registered
...
// RPC controller for deactivating an existing DID document registered
