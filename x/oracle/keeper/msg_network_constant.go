...
// NetworkConstantData creates the NetworkConstant packet
// data with obi encoded and send it to the channel
func (k msgServer) NetworkConstantData(goCtx context.Context, msg *types.MsgNetworkConstantData) (*types.MsgNetworkConstantDataResponse, error) {
	...
	return &types.MsgNetworkConstantDataResponse{}, nil
}
